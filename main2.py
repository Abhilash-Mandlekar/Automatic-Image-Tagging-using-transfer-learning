#THIS FILE WAS INITIALLY USED TO CREATE .PB FILE BUT IT IS NOW TOTALLY WORTHLESS
...
X_train, X_test, y_train, y_test = cross_validation.train_test_spIlit(features, labels, test_size=0.2, random_state=42)
